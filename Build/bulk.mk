...
__dump_targets:
	...
	$(foreach v,$(filter %LINKER %LIBS %COMPILER %FLAGS %CFLAGSBASE %INCPATH %JSONPATH %TSPATH %CLASSRANGE %_SOVERSION %_NOCHECK %_CLASSPATH %_NOGENERATED,$(filter-out MAKE%,$(.VARIABLES))),\
