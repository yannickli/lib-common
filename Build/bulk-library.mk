...
$5: $3 | _generated
	...
	$(CC) $(if $(filter %.c,$3),,-x c) -g $(CFLAGS) $$(FLAGS_) -MP -MMD -MT $5 -MF $5.d \
	    $(if $(findstring .pic,$4),-fPIC,$(CNOPICFLAGS)) -c -o $5 $3
...
$5: $3 | _generated
	...
	$(CXX) $(if $(filter %.cc %.cpp,$3),,-x c++) -g $(CXXFLAGS) $$(FLAGS_) -MP -MMD -MT $5 -MF $5.d \
	    $(if $(findstring .pic,$4),-fPIC,$(CXXNOPICFLAGS)) -c -o $5 $3
	$(call fun/obj-compress,$5)
-include $5.d
endef
...
$(3:l=c): $3
	...
	sed -i -e 's/^extern int isatty.*;//' \
	       -e '1s/^/#pragma GCC diagnostic ignored "-Wsign-compare"\n/' \
	       -e '1s/^/#pragma GCC diagnostic ignored "-Wunknown-pragmas"\n/' \
	       -e 's/^\t\tint n; \\/            size_t n; \\/' \
