...
Here are the HTTP codes returned by the platform REST interfaces:

[options="header"]
|===
| Code                        | Meaning
| 200 - OK                    | Query success
| 404 - Not Found             | The requested function does not exist
| 500 - Internal Server Error | Applicative exception (described in the JSON payload)
