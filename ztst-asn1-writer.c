...
TEST_DECL("asn1: BER encoder/decoder - constructed types", 0)
{
    ...
    uint8_t expected_1[] = {
        0xab, 0x06, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0xb5, 0x02, 0x04, 0x0f
    };

    uint8_t expected_2[] = {
        0x32, 0x30, 0xab, 0x01, 0xff, 0xcd, 0x05, 0x00, 0x87, 0x65, 0x43, 0x21,
        0xef, 0x01, 0x42, 0x64, 0x05, 0x00, 0x87, 0x65, 0x43, 0x21, 0x64, 0x09,
        0x00, 0x92, 0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0x64, 0x08, 0x12,
        0x34, 0x56, 0x78, 0x90, 0xab, 0xcd, 0xef, 0xbb, 0x01, 0x01, 0x0f, 0x02,
        0x02, 0x9a, 0x34, 0x0c, 0xab, 0x06, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67,
        0xb5, 0x02, 0x04, 0x0f
    };

    uint8_t expected_3[] = {
        0x77, 0x0c, 0xab, 0x06, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0xb5, 0x02,
        0x04, 0x0f
    };
    ...
    TEST_FAIL_IF(fail, "Global check");
    TEST_DONE();
}
