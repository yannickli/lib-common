...
class CompileDbContext(Build.BuildContext):
    ...
    def filter_task_node_cmd_input(self, cmd, task, task_node):
    ...
    @staticmethod
    def replace_task_node_cmd_output(cmd):
        if not isinstance(cmd, list):
            # This is not a list of arguments, do nothing
            return cmd
    ...
    @staticmethod
    def get_task_node_cmd(task, cmd, f_node, is_dep):
    ...
    def add_task_nodes_db(self, clang_db, task, cmd, f_nodes, is_dep):
