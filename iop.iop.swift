...
extension iop__enum_val__array_t : libcommon.IopArray { }
...
public enum iop : libcommon.IopPackage {
    ...
    public enum Presence : libcommon.IopUnion {
        public static let descriptor =  iop__presence__sp

        case `required`
        case `optional`
        case `defVal`(iop_package.Value)
        ...
        public init(_ c: Swift.UnsafeRawPointer) throws {
            ...
            switch tag {
              ...
              case 2:
                self = .optional
              case 3:
                self = .defVal(try iop_package.Value(data))
              default:
                throw libcommon.IopImportError.invalidUnionTag(type(of: self).descriptor, tag)
            }
        }
        ...
        public func fill(_ c: Swift.UnsafeMutableRawPointer, on allocator: libcommon.FrameBasedAllocator) {
            ...
            switch self {
              ...
              case .optional:
                tag[0] = 2
              case .defVal(let defVal_val):
                tag[0] = 3
                defVal_val.fill(data, on: allocator)
            }
        }
    }
    ...
    public final class Field : libcommon.IopStruct {
        ...
        public required init(_ c: Swift.UnsafeRawPointer) throws {
            ...
            var presence_var = data.pointee.presence
            self.presence = try iop_package.Presence(&presence_var)
        ...
        open override func fill(_ c: Swift.UnsafeMutableRawPointer, on allocator: libcommon.FrameBasedAllocator) {
            ...
            data.pointee.presence = self.presence.duplicated(on: allocator).bindMemory(to: iop__presence__t.self, capacity: 1).pointee
    ...
    public final class EnumVal : libcommon.IopStruct {
        ...
        public required init(_ c: Swift.UnsafeRawPointer) throws {
            let data = c.bindMemory(to: iop__enum_val__t.self, capacity: 1)
            self.name = Swift.String(data.pointee.name) ?? ""
    ...
    public final class Enum : iop_package.PackageElem {
        open override class var descriptor : Swift.UnsafePointer<iop_struct_t> {
            return iop__enum__sp
        }
        ...
        public var `values` : [iop_package.EnumVal]

        public init(`name`: Swift.String,
                    `values`: [iop_package.EnumVal] = []) {
            self.values = `values`
            super.init(name: `name`)
        }

        public required init(_ c: Swift.UnsafeRawPointer) throws {
            let data = c.bindMemory(to: iop__enum__t.self, capacity: 1)
            self.values = try data.pointee.values.buffer.map {
                var values_var = $0
                return try iop_package.EnumVal(&values_var)
                }
            try super.init(c)
        }
    ...
    public final class Typedef : iop_package.PackageElem {
        open override class var descriptor : Swift.UnsafePointer<iop_struct_t> {
            return iop__typedef__sp
        }
        ...
        public required init(_ c: Swift.UnsafeRawPointer) throws {
            let data = c.bindMemory(to: iop__typedef__t.self, capacity: 1)
    ...
    public static let classes : [libcommon.IopClass.Type] = [ PackageElem.self, Structure.self, Struct.self, Enum.self, Union.self, Typedef.self ]
}
